...
internal val logger: SkipLogger = SkipLogger(subsystem = "app.module", category = "App")

private typealias AppRootView = AppRootView
private typealias AppDelegate = AppAppDelegate
